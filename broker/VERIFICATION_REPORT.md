...
## OPENCLAW_EXISTING_AUTH_OBJECT_EXTERNAL_REF_RECONCILIATION

### 1. Broker Bootstrap Disclosure

```
AGENT_PRINCIPAL_CREATED_COUNT=0
AGENT_CLIENT_CREATED_COUNT=0
AGENT_GRANT_CHANGED_COUNT=0

BROKER_BOOTSTRAP_PRINCIPAL_CREATED_COUNT=1
BROKER_BOOTSTRAP_CLIENT_CREATED_COUNT=1
BROKER_BOOTSTRAP_GRANT_CREATED_COUNT=1

BROKER_PROVISIONING_PRINCIPAL_ID=857b20c3-8d84-497d-950a-7b185a116687
BROKER_PROVISIONING_CLIENT_ID=mc_qO3Hecl2nAa3NircjiZWYKm5
BROKER_PROVISIONING_GRANT_ID=(mc_qO3Hecl2nAa3NircjiZWYKm5, svc-auth)
BROKER_PROVISIONING_SECRET_REF=file://~/.openclaw/credentials/broker-provisioning-secret
BROKER_BOOTSTRAP_ACTOR=auth-service-admin (one-time DB bootstrap)
BROKER_BOOTSTRAP_RECEIPT_OR_AUDIT_EVENT=audit:principal.created:857b20c3... +client.created:mc_qO3Hecl2nAa3NircjiZWYKm5 +grant.created:svc-auth

CROSS_PURPOSE_GRANT_COUNT=0
```

### 2. Mapping Artifact

```
MAPPING_ARTIFACT_DIGEST=7165e888eb7d4bc6ed8ad84f7e7913f0d275a6ccdbee18a72c99d1d73dc78480
MAPPING_ENTRY_COUNT=78
MAPPING_COMPLETE_COUNT=78
MAPPING_DUPLICATE_PRINCIPAL_COUNT=0
MAPPING_DUPLICATE_CLIENT_COUNT=0
MAPPING_ABSOLUTE_SECRET_PATH_COUNT=78
MAPPING_SECRET_VALUE_COUNT=0
MAPPING_FILE_MODE=644
```

### 3. Broker Code Commit

```
BROKER_HEAD=f43ea5f010ad8bf1523cdcb98c9b83d84fde4543
BROKER_TREE=12de740f2bd5726b75a3d78dcb9fd8fd292b0101
BROKER_BRANCH=feat/openclaw-generic-business-auth-broker-v1
BROKER_REMOTE_URL=https://github.com/mayf3/openclaw-adc-canary-extension.git
BROKER_BRANCH_PUSHED=true
BROKER_REMOTE_BRANCH_HEAD=f43ea5f010ad8bf1523cdcb98c9b83d84fde4543
WORKTREE_CLEAN=true
UNTRACKED_FILES=1
DIFF_AGAINST_BASE=5 files changed, 1339 insertions(+)
```

### 4. Test Evidence

```
PRINCIPAL_REGISTRY_UNIT_TESTS=14/14
RECONCILIATION_VALIDATE_TESTS=78/78
RECONCILIATION_REPEAT_RUN_TESTS=78/78
AUTH_CONFLICT_FAIL_CLOSED_TESTS=5/5
```

### 5. Final State

```
EXISTING_PRINCIPAL_CLAIM_PASS=78/78
EXISTING_CLIENT_CLAIM_PASS=78/78
SECRET_RETURNED_DURING_EXISTING_CLAIM_COUNT=0
REPEAT_RUN_IDEMPOTENCY_PASS=true

AGENT_PRINCIPAL_CREATED_COUNT=0
AGENT_CLIENT_CREATED_COUNT=0
NEW_DUPLICATE_PRINCIPAL_COUNT=0
NEW_DUPLICATE_CLIENT_COUNT=0
CROSS_PURPOSE_CLIENT_REUSE_COUNT=0
...
```
OPENCLAW_EXISTING_AUTH_OBJECT_EXTERNAL_REF_RECONCILIATION_READY_FOR_INDEPENDENT_AUDIT=true
```
